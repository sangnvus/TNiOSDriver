...
@synthesize DataInfoTrip;
@synthesize DateTime,FromAdress,ToAdress,Status;
- (void)awakeFromNib {
    // Initialization code
}
...
{
    self.DateTime.text=[data objectForKey:@"time"];
    self.FromAdress.text=[data objectForKey:@"fromAddress"];
    self.ToAdress.text=[data objectForKey:@"toAddress"];
    self.Status.text=[data objectForKey:@"status"];
//    if ([[data objectForKey:@"promotionTripRiders"] isEqualToString:@""]) {
//        self.riderRequest.text=@"non";
//    }
//    else
//    {
//
//        NSArray *dataRider=[data objectForKey:@"promotionTripRiders"];
//
//        self.riderRequest.text=[NSString stringWithFormat:@"%i",dataRider.count];
//    }
