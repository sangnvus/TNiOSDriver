            ...
            else
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            [unity register_by_email:self.EmailUser.text password:self.PassUser.text firstname:@"ha" lastname:self.NameUser.text phone:self.PhoneUser.text language:@"en" usergroup:@"DR" countrycode:@"VN"];
                            // show alert
